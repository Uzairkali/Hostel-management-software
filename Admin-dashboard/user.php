      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <span class="navbar-brand">Student's Information</span>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Full Details are been displayed</p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-hover table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="font-weight-bold">Year of Admission</th>
                      ...
                      <tbody id="myTable">
                        ...
                        <td><?php echo $row->ur_mail;?></td>
                        <td><?php echo $row->u_ph;?></td>
                        <td><?php echo $row->Fn;?></td>
                        <td><?php echo $row->foc;?></td>
                        <td><?php echo $row->fpho;?></td>
                        ...
                        <td><?php echo $row->u_sem;?></td>
                        <td><?php echo $row->u_admis;?></td>
                        <td><?php echo $row->u_year;?></td>
                        <td>&nbsp;&nbsp;
                        <a href="user.php?del=<?php echo $row->ID;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
                                            </tr>
                                          <?php
                        $cnt=$cnt+1;
                                          } ?>
