...
if(isset($_GET['del']))
{
	...
	$adn="delete from rooms where id=?";
        ...
        $stmt->execute();
        $stmt->close();	   
        echo "<script>alert('Room Data Deleted');</script>" ;
}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <span class="navbar-brand">Manage Room</span>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="h4-responsive card-title">Manage Rooms</h4>
                  <p class="card-category">Room Details</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover table-bordered">
                      <tr>
                        ...
                        <th class="font-weight-bold">Room no</th>
                        <th class="font-weight-bold">Seater</th>
